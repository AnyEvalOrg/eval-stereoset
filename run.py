#!/usr/bin/env python3
"""Run ONE problem of stereoset through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one stereoset problem via TrustedRouter")
