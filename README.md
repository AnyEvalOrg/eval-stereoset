...
A dataset that measures stereotype bias in language models across gender, race, religion, and
profession domains. Models choose between stereotype, anti-stereotype, and unrelated
completions to sentences.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/stereoset`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/stereoset) |
| Group | Safeguards |
| Total samples | 4,299 |
...
- `huggingface` — `McGill-NLP/stereoset` (pinned)
